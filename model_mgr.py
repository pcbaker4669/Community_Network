...
class SNA_Model_Mgr:
    ...
    def __init__(self):
        ...
        self.g = None
        self.sna_model = None
        self.selection_mult = 1  # how many attempts to find a good node * total nodes
    ...
    def setup(self):
        ...
        for i in range(0, self.start_node_num):
            ...
            coefficient = (i+1) / (self.start_node_num + 1)
            print("word metric coefficient =", coefficient)
            starter_node.set_ideological_score(coefficient)
            ...
            if old_tgt_in_degree > 1:
                ...
                if new_match is None:
                    print("new_nodes_skipped {}, total modified {}, cnt this run {}"
                          .format(self.new_parent_needed, self.tot_mods, node_mod_cnt))
                    self.new_parent_needed += 1
                    continue
    ...
    def draw_network(self):
        ...
        for i in self.g.nodes:
            d[i] = self.sna_model.get_nodes()[i].get_ideological_score()
        print("d = ", d)
